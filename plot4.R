      ...
      png("plot4.png")
      par(mfcol=c(2,2))      
      plot(dataset[,10],dataset[,3],type="l",xlab="",ylab="Global Active Power")
      ...
      legend("topright",names(dataset[,7:9]),col=c("black","red","blue"),lty=1,bty="n",cex=.75)
      
      plot(dataset[,10],dataset[,5],type="l",xlab="datetime",ylab="Voltage")
      
      plot(dataset[,10],dataset[,4],type="l",xlab="datetime",ylab="Global_reactive_power")
